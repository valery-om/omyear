...
edge guard reserves one of six daily live-generation slots and rejects accidental
duplicates. Each of the three editorial calls also has a 48 KB prompt ceiling and a 6,000-token output ceiling,
