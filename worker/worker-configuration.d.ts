/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a6892fd5f03b39133d8e8ae4022ba764)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 
interface __BaseEnv_Env {
	GENERATE_RATE_LIMITER: RateLimit;
	BACKEND_URL: "https://omyear-backend.vercel.app/api/generate";
	SITE_ORIGIN: "https://omyear.pages.dev";
	APP_ORIGIN: "https://app.omyear.com";
	DAILY_GENERATION_LIMIT: "8";
	DUPLICATE_WINDOW_SECONDS: "300";
	BACKEND_SHARED_SECRET: string;
	GENERATION_GUARD: DurableObjectNamespace<import("./src/index").GenerationGuard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GenerationGuard";
	}
